...
export function Hero({ data }: HeroProps) {
  return (
    <section className="relative overflow-hidden pb-12 pt-8 text-center lg:pb-20 lg:pt-12">
      <div className="relative mx-auto max-w-3xl">
        ...
        >
          <span className="h-px w-12 bg-bordeaux/40" aria-hidden />
        ...
        {data.heroSubtitle && (
          <motion.p
            ...
            className="mx-auto mt-8 max-w-md text-base leading-relaxed text-ink-soft sm:text-lg"
          >
            {data.heroSubtitle}
          </motion.p>
        )}
        ...
        <motion.div
          ...
          className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row sm:items-center"
        >
      ...
      <motion.div
        ...
        className="pointer-events-none mx-auto mt-10 h-px max-w-xl origin-center bg-bordeaux/20 stitch-border lg:mt-14"
